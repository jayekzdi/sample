 ...
 ?>
        <div class="col-lg-12 col-lg-9 col-md-6">
            <table class="table table-condensed">
            	...
            	<?php echo manage_drinks($connect);?>
            </table>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form method="post" class="form-inline">
       	<label>Drinks:</label>
       	<input type="text" name="input_drinks" placeholder="Drinks" class="form-control">
       	<input type="submit" name="add_drinks" class="btn btn-info btn-xs" value="Add Dessert">
       </form>
      </div>
...
if(isset($_POST["add_drinks"])){
 ...
 $add=$_POST["input_drinks"];
 $sql="insert into pax_drinks(dr_name) values ('".$add."')";
 $result=mysqli_query($connect,$sql);
