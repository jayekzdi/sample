    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form method="post" class="form-inline">
       	<label>Drinks:</label>
       	<input type="text" name="input_soup" placeholder="Soup" class="form-control">
       	<input type="submit" name="add_soup" class="btn btn-info btn-xs" value="Add Soup">
       </form>
      </div>
...
if(isset($_POST["add_soup"])){
 ...
 $add=$_POST["input_soup"];
 $sql="insert into pax_soup(soup_name) values ('".$add."')";
 $result=mysqli_query($connect,$sql);
 echo 'alert("Dish Added");
 	window.location.href="soup.php";
 }
 </script>';
}
?>