 ...
 ?>
        <div class="col-lg-12 col-lg-9 col-md-6">
            <table class="table table-condensed">
            	...
            	<?php echo ads_event($connect);?>

            </table>
                
 <button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#myModal">Add Events</button>
 <!-- Modal -->
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form method="post" class="form-group" enctype="multipart/form-data">
       	...
       	<textarea rows="5" class="form-control" name="input_content"></textarea>
       	<label>Event Image:</label>
       	<input type="file" name="input_img">
       	<br>
       	<input type="submit" name="add_event" class="btn btn-info btn-xs" value="Submit">
       </form>
      </div>
...
$insert_image="INSERT INTO ads_event(event_title,event_content,event_path,event_img) VALUES('".$add_title."','".$add_content."','$folder','$imagename')";
mysqli_query($connect,$insert_image);
 echo '<script>alert("Image Added");
 	window.location.href="ads_events.php";
 </script>';
}
?>