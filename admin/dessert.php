 ...
 ?>
        <div class="col-lg-12 col-lg-9 col-md-6">
            <table class="table table-condensed">
            	...
            	<?php echo manage_dessert($connect);?>
            </table>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form method="post" class="form-inline">
       	<label>Dessert:</label>
       	<input type="text" name="input_dessert" placeholder="Dessert" class="form-control">
       	<input type="submit" name="add_dessert" class="btn btn-info btn-xs" value="Add Dessert">
       </form>
      </div>
...
if(isset($_POST["add_dessert"])){
 ...
 $add=$_POST["input_dessert"];
 $sql="insert into pax_dessert(des_name) values ('".$add."')";
 $result=mysqli_query($connect,$sql);
