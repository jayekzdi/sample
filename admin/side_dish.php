 ...
 ?>
        <div class="col-lg-12 col-lg-9 col-md-6">
            <table class="table table-condensed">
            	...
            	<?php echo manage_side_dish($connect);?>
            </table>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form method="post" class="form-inline">
       	<label>Dish:</label>
       	<input type="text" name="input_dish" placeholder="Side Dish" class="form-control">
...
if(isset($_POST["add_dish"])){
 ...
 $sql="insert into pax_side_dish(side_dish_name) values ('".$add_dish."')";
 $result=mysqli_query($connect,$sql);
 echo 'alert("Dish Added");
 	window.location.href="side_dish.php";
 }
 else{
