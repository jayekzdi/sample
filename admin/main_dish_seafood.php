 ...
 ?>
        <div class="col-lg-12 col-lg-9 col-md-6">
            <table class="table table-condensed">
            	...
            	<?php echo manage_seafood($connect);?>
            </table>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form method="post" class="form-inline">
       	<label>Dish:</label>
       	<input type="text" name="input_dish" placeholder="Seafood Dish" class="form-control">
...
if(isset($_POST["add_dish"])){
 ...
 $sql="insert into pax_main_dish(main_dish_name,main_dish_type) values ('".$add_dish."','Seafoods')";
 $result=mysqli_query($connect,$sql);
 echo 'alert("Dish Added");
 	window.location.href="main_dish_seafood.php";
 }</script>';
}
?>