...
$id=$_GET["side_dish_id"];
						$sql="select * from pax_side_dish where side_dish_id='".$id."'"or die("invalid query".mysqli_error());
...
include 'leftnav.php';
 ?>
        <div class="col-lg-12 col-lg-9 col-md-6">
          ...
          <button class="btn btn-md btn-inverse"><a href="side_dish.php">Back</a></button>
</div>
<!--/.container-->
