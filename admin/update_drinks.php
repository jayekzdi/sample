...
$id=$_GET["dr_id"];
						$sql="select * from pax_drinks where dr_id='".$id."'" or die("Invalid Query".mysqli_query());
 ...
 ?>
        <div class="col-lg-12 col-lg-9 col-md-6">
          ...
          <div class="well">
          	...
          	<label>Dessert:</label>
          	<input type="text" name="input_edit" class="form-control" value="<?php echo $row["dr_name"];?>">
...
if(isset($_POST["edit_main_dish"])){
	...
	$sql="update pax_drinks set dr_name='".$update."' where dr_id='".$id."'";
	$result=mysqli_query($connect,$sql);
