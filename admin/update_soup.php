...
$id=$_GET["soup_id"];
						$sql="select * from pax_soup where soup_id='".$id."'" or die("Invalid Query".mysqli_query());
...
include 'leftnav.php';
 ?>
        <div class="col-lg-12 col-lg-9 col-md-6">
           <LABEL>EDIT SOUP</LABEL>
          <div class="well">
          	<form role="form" method="POST" class="form-inline">
          	<label>Soup:</label>
          	<input type="text" name="input_edit" class="form-control" value="<?php echo $row["soup_name"];?>">
          	<input type="submit" name="edit_main_dish" class="btn btn-md btn-inverse" value="Update">
          	</form>
          </div>
          <button class="btn btn-md btn-inverse"><a href="drinks.php">Back</a></button>
</div>
<!--/.container-->
...
if(isset($_POST["edit_main_dish"])){
	...
	$sql="update pax_soup set soup_name='".$update."' where soup_id='".$id."'";
	$result=mysqli_query($connect,$sql);
