...
$id=$_GET["des_id"];
						$sql="select * from pax_dessert where des_id='".$id."'" or die("Invalid Query".mysqli_query());
...
include 'leftnav.php';
 ?>
        <div class="col-lg-12 col-lg-9 col-md-6">
           <LABEL>EDIT DESSERT</LABEL>
          <div class="well">
          	<form role="form" method="POST" class="form-inline">
          	<label>Dessert:</label>
          	<input type="text" name="input_edit" class="form-control" value="<?php echo $row["des_name"];?>">
          	<input type="submit" name="edit_main_dish" class="btn btn-md btn-inverse" value="Update">
          	</form>
          </div>
          <button class="btn btn-md btn-inverse"><a href="dessert.php">Back</a></button>
</div>
<!--/.container-->
...
if(isset($_POST["edit_main_dish"])){
	...
	$sql="update pax_dessert set des_name='".$update."' where des_id='".$id."'";
	$result=mysqli_query($connect,$sql);
