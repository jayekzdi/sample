...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 10, 2017 at 09:19 AM
...
CREATE TABLE `reservation` (
  ...
  `res_time_period` varchar(250) NOT NULL,
...
INSERT INTO `sample` (`id`, `pack`) VALUES
(1, 'Fried Chicken'),
(2, 'Array'),
(3, 'Pork Hamonado,Porkloin with Mushroom Sauce,Porkloin in Mushroom with Quail Eggs,'),
(4, 'Chicken Roll,Fried Chicken,Kare Kare,'),
(5, 'Pork Hamonado,Porkloin with Mushroom Sauce,Porkloin in Mushroom with Quail Eggs,');
...
(1, 'John Joshua Bala', 'jayeksdi', 'jhnbala@gmail.com', '09552131094', 'e2447a4f5b6e8fc32f9523d9750e3cdf', 'Aug/26/1998', 'Male');
